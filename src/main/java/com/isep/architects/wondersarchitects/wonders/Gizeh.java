...
public class Gizeh extends Wonder{
    ...
    public void buildStage() {
        ...
        this.stages.add(new WonderStage(2,true,2, new int[]{1},5,this,233,false));
        this.stages.add(new WonderStage(3,false,3, new int[]{2},6,this,233,false));
        this.stages.add(new WonderStage(3,true,4, new int[]{3},7,this,233,false));
        this.stages.add(new WonderStage(4,false,5, new int[]{4},8,this,233,false));
    }
    ...
    public void fillPile(){
        ...
        pile.addMultiple(CardsTypes.BRICK,1);
        ...
        pile.addMultiple(CardsTypes.RED2,0);
